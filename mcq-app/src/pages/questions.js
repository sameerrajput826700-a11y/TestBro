...
export async function createQuestionsPage() {
    ...
    try {
        ...
        if (questions.length === 0) {
            main.appendChild(createEmptyState('📚', 'No Questions Found', 'Import questions or create a new question to get started.'));
        }
        else {
            // Stats
      ...
      `;
            ...
            function updateList() {
                ...
                if (filtered.length === 0) {
                    listDiv.appendChild(createEmptyState('🔍', 'No Results', 'No questions match your filters.'));
                }
                else {
        ...
        main.innerHTML = '';
        main.appendChild(createEmptyState('❌', 'Error', 'Failed to load questions. Please refresh the page.'));
    }
