...
import type { TestSession, TestConfiguration } from '../models/types';

export async function createTestScreenPage(): Promise<HTMLElement> {
  ...
  try {
    ...
    const activeSession: TestSession = sessionData;
    ...
    const activeConfig: TestConfiguration = config;
    ...
    function updatePalette() {
      ...
      activeSession.questionIds.forEach((qId: string, index: number) => {
