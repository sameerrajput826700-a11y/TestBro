...
export async function createImportPage(): Promise<HTMLElement> {
  ...
  const offlineModules = Object.entries(
    import.meta.glob('../../offline-question-bank/*.json', { eager: true, import: 'default' }) as Record<string, any>
  ) as Array<[string, any]>;
  ...
  function showValidationResults(
    ...
    invalidQuestions: Array<{ data: any; error: string }>,
    duplicateIds: string[]
  ): void {
