...
describe('TestEngine scoring and duplicate handling', () => {
    ...
    it('keeps duplicate question ids distinct while preserving original ids for display', async () => {
        const q1 = makeQuestion({ id: '001', question: 'Question 1', answer: 0, _internalKey: 'internal_1' });
        const q2 = makeQuestion({ id: '001', question: 'Question 2', answer: 1, _internalKey: 'internal_2' });
        const config = {
            id: 'cfg2',
            name: 'Test',
            numberOfQuestions: 2,
